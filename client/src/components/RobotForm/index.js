    ...
    return (
      <div className='form-container'>
        <form
          ...
          <label 
            htmlFor='current_name' 
            className='robot-form__label'>Current Name:</label>
          <input 
            type='text' 
            name='current_name' 
          ...
          <label 
            htmlFor='height' 
            className='robot-form__label'>Height:</label>
          <input 
            type='number' 
            placeholder='feet'
            name='height' 
          ...
          <label 
            htmlFor='weight' 
            className='robot-form__label'>Weight:</label>
          <input 
            type='number' 
            placeholder='pounds'
            name='weight' 
            ...
            onChange={this.handleChange} />
          <label 
            htmlFor='intelligence_metric' 
            className='robot-form__label'>Intelligence Metric:</label>
          <input 
            type='number'
            step='1'
            min='1'
          ...
          <label 
            htmlFor='date_added' 
            className='robot-form__label'>Date Added:</label>
          <input 
            type='text' 
            name='date_added'
            ...
            onChange={this.handleChange} />
          <label 
            htmlFor='first_active' 
            className='robot-form__label'>First Active:</label>
          <input 
            type='text' 
            name='first_active'
            placeholder='YYYY-MM-DD' 
